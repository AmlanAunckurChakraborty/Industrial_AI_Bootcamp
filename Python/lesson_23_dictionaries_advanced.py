...
print("\n========== DICTIONARY INSIDE LIST ==========\n")
compressors = [{"Name":"A","Pressure":520,"Temperature":42},{"Name":"B","Pressure":530,"Temperature":44},{"Name":"C","Pressure":510,"Temperature":40}]
print(compressors)
...
print("\n========== LIST INSIDE DICTIONARY ==========\n")
plant = {"Pressure":[520,530,540],"Temperature":[42,44,46],"Flow":[120,125,130]}
print(plant)
print("\nPressure List")
...
# MIXED EXAMPLE
print("\n========== MIXED EXAMPLE ==========\n")
plant = {"Compressor_A":{"Pressure":[520,521,522],"Temperature":[42,43,44]},"Compressor_B":{"Pressure":[530,531,532],"Temperature":[45,46,47]}}
print(plant)
...
# Dynamic Compressor Database
plant = {compressor: {"Pressure": 520 + (index * 10), "Temperature": 40 + index, "Flow": 120 + (index * 5), "Running": True}
    for index, compressor in enumerate(["Compressor_A","Compressor_B","Compressor_C","Compressor_D","Compressor_E"])}
print(plant)
print("\nCompressor C")
print(plant["Compressor_C"])